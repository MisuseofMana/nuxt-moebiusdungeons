export default {
    minorHeal: {
        ...
        icon: require("@/assets/images/items/cleric/heal1.png")
    },
    ...
    minorBlessing: { 
        ...
        icon: require("@/assets/images/items/cleric/boon.png")
    },
    ...
    fortune: {
        ...
        icon: require('@/assets/images/items/cleric/fortune.png')
    },
    ...
    greaterHeal: {
        ...
        icon: require("@/assets/images/items/cleric/heal2.png")
    },
    ...
    favorOfAmara: {
        ...
        icon: require("@/assets/images/items/cleric/immune2.png")
    },
    ...
    greatBlessing: {
        ...
        icon: require("@/assets/images/items/cleric/boonGold.png")
    },
    ...
    greatMiracle: {
        ...
        icon: require("@/assets/images/items/cleric/boostAttack.png")
    },
