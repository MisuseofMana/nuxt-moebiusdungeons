...
const components = {
  ...
  CharacterImageMock: () => import('../..\\components\\Atoms\\CharacterImage\\CharacterImage.mock.js' /* webpackChunkName: "components/character-image-mock" */).then(c => wrapFunctional(c.default || c)),
  CharacterImage: () => import('../..\\components\\Atoms\\CharacterImage\\CharacterImage.vue' /* webpackChunkName: "components/character-image" */).then(c => wrapFunctional(c.default || c)),
