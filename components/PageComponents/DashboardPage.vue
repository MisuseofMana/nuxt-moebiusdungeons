    ...
    <v-row>
      ...
      <v-col cols="4" @click="changePhase('CharacterSelectPage')">
        <ContentCard hoverable>
          <v-img
            class="cursorPointer"
            :src="require('@/assets/images/sigils/player.png')"
            max-height="100"
            max-width="100"
          />
      ...
      <v-col cols="4">
        <ContentCard
          v-if="savedGame"
          hoverable
          class="pa-4 text-h6 d-flex align-center justify-center text-center"
          height="25vh"
        >
          <div>Load Game</div>
        </ContentCard>
    ...
    <v-row>
      <v-col cols="4">
        ...
        >
          <v-img
            class="cursorPointer"
            :src="require('@/assets/images/ui/discord.png')"
            max-height="50"
            max-width="50"
          />
          <div class="text-h6">DISCORD</div>
          <div class="text-body-1">
            Click here to join the Moebius Dungeon discord server where you can
            talk about the game, suggest improvements and stay in touch.
          </div>
        </ContentCard>
      </v-col>
      <v-spacer></v-spacer>
      <v-col cols="4" @click="changePhase('LeaderBoardPage')">
        ...
        >
          <v-img
            class="cursorPointer"
            :src="require('@/assets/images/sigils/traveler.png')"
            max-height="100"
            max-width="100"
          />
