      ...
      <v-row no-gutters justify="center">
        ...
        >
          <div @click="selectShopKeeper(randomShopKeepers[0])">
            <CharacterImage
              :who="characters[randomShopKeepers[0]]"
              class="cursorPointer mr-5"
            />
          </div>
          <div @click="selectShopKeeper(randomShopKeepers[1])">
            <CharacterImage
              :who="characters[randomShopKeepers[1]]"
              class="cursorPointer mr-5"
            />
          </div>
          <div @click="selectShopKeeper(randomShopKeepers[2])">
            <CharacterImage
              :who="characters[randomShopKeepers[2]]"
              class="cursorPointer"
            />
          </div>
        </v-col>
